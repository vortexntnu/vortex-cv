...
class DrawTools:
    ...
    def drawcircle(self, img, center_coordinates=(10, 20), color=(255, 0, 0), radius=5, thickness=2):
    ...
    def draw_all_circles(self, img, dst, radius):
        ...
        points = np.reshape(dst, (4,2))
        self.drawcircle(img, center_coordinates=(points[0][0], points[0][1]), color=(255, 0, 0),     radius=radius)
        self.drawcircle(img, center_coordinates=(points[1][0], points[1][1]), color=(0, 255, 0),     radius=radius)
        self.drawcircle(img, center_coordinates=(points[2][0], points[2][1]), color=(0, 0, 255),     radius=radius)
        self.drawcircle(img, center_coordinates=(points[3][0], points[3][1]), color=(255, 255, 255), radius=radius)
