...
noise_rm_params = [
    ksize1, ksize2, sigma, thresholding_blocksize, thresholding_C,
    erosion_dilation_ksize, erosion_iterations, dilation_iterations
]

_, hsv_mask, hsv_mask_validation_img = feature_detector.hsv_processor(
    img, *hsv_params)

noise_filtered_img = feature_detector.noise_removal_processor(
    hsv_mask, *noise_rm_params)

path_contour = feature_detector.contour_processing(noise_filtered_img,
