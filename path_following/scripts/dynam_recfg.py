...
class DynamicReconfigure(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ddr.add_variable("canny_threshold1",
                              "threshold 1 for the hypertesis", 100, 0, 1000)
        self.ddr.add_variable("canny_threshold2",
                              "threshold 2 for the hypertesis", 200, 0, 1000)
        canny_aperture_size_enum = self.ddr.enum([
        ...
        self.ddr.add_variable("canny_aperture_size",
                              "A size parameter which is edited via an enum",
                              3,
                              3,
                              7,
                              edit_method=canny_aperture_size_enum)
