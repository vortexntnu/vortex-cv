...
def generate_launch_description():
    return LaunchDescription(
        declare_drone_and_namespace_args()
        + [
            DeclareLaunchArgument('target_x', default_value='1.777425535555405',
                                  description='Pipeline target X in odom frame'),
            DeclareLaunchArgument('target_y', default_value='-0.053997583427242916',
                                  description='Pipeline target Y in odom frame'),
            DeclareLaunchArgument('target_z', default_value='5.301166999942316',
