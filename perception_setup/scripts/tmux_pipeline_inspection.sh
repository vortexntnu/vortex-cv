...
Options:
  ...
  --gst                    Flag. Enable GStreamer streaming for the down camera.
...
tmux send-keys -t "$PANE_P1" "source install/setup.bash && ros2 launch perception_setup pipeline_inspection_front_camera.launch.py$FRONT_ARGS" Enter
