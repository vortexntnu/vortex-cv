...
class OdometryToPath:
    ...
    def __init__(self):
        ...
        self.path_publisher = rospy.Publisher("nav_msgs/Path",
                                              Path,
                                              queue_size=10)
        rospy.Subscriber("/tracking/tracked_cv_object", Odometry,
                         self.single_track_callback)
        self.path = Path()
        ...
        rospy.Subscriber("/tracking/mul_tracked_cv_objects", OdometryArray,
                         self.mul_tracks_callback)
