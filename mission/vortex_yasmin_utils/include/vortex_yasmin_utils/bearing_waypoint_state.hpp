...
/**
 * @brief Navigates to a pose stored in the blackboard by a bearing collection
 * step.
 *
 ...
 *
 * The yaw is taken from the pose orientation (heading toward the bearing
 * target). If desired_altitude >= 0, the waypoint z is overridden with that
 * absolute value.
 *
 ...
 * @param desired_altitude      Absolute z to use for the waypoint. Negative =
 * use bearing server z.
