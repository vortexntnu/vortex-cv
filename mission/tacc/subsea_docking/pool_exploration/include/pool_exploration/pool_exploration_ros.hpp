#ifndef POOL_EXPLORATION__POOL_EXPLORATION_ROS_HPP_
#define POOL_EXPLORATION__POOL_EXPLORATION_ROS_HPP_
...
class PoolExplorationNode : public rclcpp::Node {
   ...
   private:
     ...
     * through the SendWaypoints service. The request uses the configured
    ...
    /** @brief Pool exploration planner used for corner detection and docking
     * estimation. */
...
#endif  // POOL_EXPLORATION__POOL_EXPLORATION_ROS_HPP_
