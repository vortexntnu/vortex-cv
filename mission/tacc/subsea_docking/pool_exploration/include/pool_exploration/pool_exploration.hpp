...
#define POOL_EXPLORATION__POOL_EXPLORATION_HPP_
 ...
 * intersection point in the planning frame.
 */
 ...
 *
 * The planner classifies detected line segments as candidate pool walls,
...
class PoolExplorationPlanner {
   public:
     ...
     */
    explicit PoolExplorationPlanner(const PoolExplorationPlannerConfig& config);
   ...
   private:
     ...
     * line segment.
     *
     * If the segment is degenerate, the first endpoint is returned. ANNEN
     * HÅNDTERING? TO DO
     *
...
#endif  // POOL_EXPLORATION__POOL_EXPLORATION_HPP_
