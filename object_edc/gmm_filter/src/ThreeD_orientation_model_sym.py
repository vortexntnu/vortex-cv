...
def init():
    ...
    R_cw = Matrix([[r11, r12, r13], [r21, r22, r23], [r31, r32, r33]])

    ## Trying with euler angles
    phi_lw, theta_lw, psi_lw = symbols("phi_lw, theta_lw, psi_lw")
    landmark_space_orienter = SpaceOrienter(phi_lw, theta_lw, psi_lw,
                                            "123")  # This can go very wrong
    ...
    return lambdify([
        r11, r12, r13, r21, r22, r23, r31, r32, r33, phi_lw, theta_lw, psi_lw
    ], Jac, 'numpy')
