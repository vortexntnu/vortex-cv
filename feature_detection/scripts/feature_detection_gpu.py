...
class ImageFeatureProcessingGPU(object):
    ...
    def __init__(self, image_shape, *args, **kwargs):
        ...
        super(ImageFeatureProcessingGPU, self).__init__(*args, **kwargs)
...
class PointsProcessingGPU(object):
    ...
    def __init__(self, len_of_integral_binary_resetter=5, icp_ref_points=None, *args, **kwargs):
        self.points_processing_image_shape = (720, 1280, 4) # Only used for drawing data on image. Gets adaptively overwritten by init argument from FeatureDetectionGPU class.
        ...
        super(PointsProcessingGPU, self).__init__(*args, **kwargs)
...
class ShapeProcessingGPU(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(ShapeProcessingGPU, self).__init__(*args, **kwargs)
...
class FeatureDetectionGPU(ImageFeatureProcessingGPU, PointsProcessingGPU, ShapeProcessingGPU):
    ...
    def __init__(self, image_shape, len_of_integral_binary_resetter=5, icp_ref_points=None):
        super(FeatureDetectionGPU, self).__init__(image_shape=image_shape, len_of_integral_binary_resetter=len_of_integral_binary_resetter, icp_ref_points=icp_ref_points)
